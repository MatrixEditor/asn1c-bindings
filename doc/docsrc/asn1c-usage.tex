...
{\ttfamily -no-gen-CBOR} & {\small Do not generate the Concise Binary Object Representation (CBOR, RFC~7049) support code. By default, CBOR support code is generated.}\\
...
Object Representation, RFC~7049) data stream into the target ASN.1 structure.
...
canonical CBOR (Concise Binary Object Representation, RFC~7049) byte stream.
