...
asn1_namespace_t *asn1_namespace_new() {
...
void asn1_namespace_free(asn1_namespace_t *ns) {
    if (ns) {
...
asn1_namespace_t *asn1_namespace_clone(const asn1_namespace_t *old_ns) {
        ...
        switch (old_ns->elements[i].selector) {
            case NAM_SPACE:
                asn1_namespace_add_module(
                    new_ns, old_ns->elements[i].u.space.module,
...
static size_t _add_element(asn1_namespace_t *ns) {
...
void asn1_namespace_add_symbol(asn1_namespace_t *ns,
...
asn1_namespace_t *asn1_namespace_new_from_module(struct asn1p_module_s *module,
                                                 int stop_search) {
...
void asn1_namespace_add_module(asn1_namespace_t *ns,
...
const char *asn1_namespace_string(const asn1_namespace_t *ns) {
    static abuf ab;
