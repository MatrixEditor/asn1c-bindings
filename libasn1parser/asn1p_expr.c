...
static asn1p_expr_t *asn1p_expr_clone_impl(
    asn1p_expr_t *expr, int skip_extensions,
    asn1p_expr_t *(*)(asn1p_expr_t *, void *), void *);
static asn1p_value_t *value_resolver(asn1p_value_t *, void *arg);

void asn1p_expr_set_source(asn1p_expr_t *expr, asn1p_module_t *module,
                           int lineno) {
    if (expr) {
        expr->module = module;
        expr->_lineno = lineno;
...
int asn1p_expr_compare(const asn1p_expr_t *a, const asn1p_expr_t *b) {
    if ((a && !b) || (!a && b)) {
        return -1;
    }
    ...
    if ((!a->constraints && b->constraints) ||
        ...
        return -1;
               ...
               asn1p_constraint_compare(a->constraints, b->constraints)) {
        return -1;
    }
 ...
 */
asn1p_expr_t *asn1p_expr_new(int _lineno, asn1p_module_t *mod) {
    asn1p_expr_t *expr;
...
asn1p_expr_t *asn1p_expr_clone(asn1p_expr_t *expr, int skip_extensions) {
    return asn1p_expr_clone_impl(expr, skip_extensions, 0, 0);
}

asn1p_expr_t *asn1p_expr_clone_with_resolver(asn1p_expr_t *expr,
                                             asn1p_expr_t *(*r)(asn1p_expr_t *,
                                                                void *),
                                             void *rarg) {
...
static asn1p_expr_t *asn1p_expr_clone_impl(
    asn1p_expr_t *expr, int skip_extensions,
    asn1p_expr_t *(*r)(asn1p_expr_t *, void *), void *rarg) {
...
#define CLVRCLONE(field, func)                          \
    ...
    if (r) {
        ...
        if (clone) {
            /* Merge constraints */
            if (expr->constraints) {
                asn1p_constraint_t *tmpct =
                    asn1p_constraint_clone_with_resolver(expr->constraints, vr,
                                                         rarg);
    ...
    TQ_FOR (tcmemb, &(expr->members), next) {
        ...
        if (skip_extensions && tcmemb->expr_type == A1TC_EXTENSIBLE) {
...
static asn1p_value_t *value_resolver(asn1p_value_t *value, void *rarg) {
    asn1p_value_t *cval;
    ...
    if (!target) return NULL; /* errno's are compatible */
...
const char *asn1p_tag2string(const struct asn1p_type_tag_s *tag, char *buf) {
    ...
    buf += snprintf(buf + strlen(buf), end - buf, "%s]",
                    asn1p_itoa(tag->tag_value));
...
asn1p_paramlist_t *asn1p_get_namespace(asn1p_expr_t *expr) {
    if (!expr) return NULL;
