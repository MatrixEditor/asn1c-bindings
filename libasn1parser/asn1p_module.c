 ...
 */
asn1p_module_t *asn1p_module_new() {
    asn1p_module_t *mod;
...
void asn1p_module_free(asn1p_module_t *mod) {
    if (mod) {
        ...
        while ((expr = TQ_REMOVE(&(mod->members), next))) asn1p_expr_free(expr);
...
void asn1p_module_member_add(asn1p_module_t *mod, asn1p_expr_t *expr) {
    if (expr) {
