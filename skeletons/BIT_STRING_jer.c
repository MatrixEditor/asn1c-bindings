...
asn_enc_rval_t BIT_STRING_encode_jer(const asn_TYPE_descriptor_t *td,
    ...
    const asn_jer_constraints_t *cts =
        constraints ? constraints : td->encoding_constraints.jer_constraints;
    uint8_t *buf;
    uint8_t *end;
...
asn_dec_rval_t BIT_STRING_decode_jer(const asn_codec_ctx_t *opt_codec_ctx,
