...
asn_dec_rval_t BMPString_decode_jer(const asn_codec_ctx_t *opt_codec_ctx,
    ...
    rc = OCTET_STRING_decode_jer_utf8(opt_codec_ctx, td, constraints, sptr,
                                      buf_ptr, size);
    if (rc.code == RC_OK) {
        /*
...
asn_enc_rval_t BMPString_encode_jer(const asn_TYPE_descriptor_t *td,
                                    const asn_jer_constraints_t *constraints,
