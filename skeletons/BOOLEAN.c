...
void BOOLEAN_free(const asn_TYPE_descriptor_t *td, void *ptr,
...
int BOOLEAN_compare(const asn_TYPE_descriptor_t *td, const void *aptr,
                    const void *bptr) {
...
int BOOLEAN_copy(const asn_TYPE_descriptor_t *td, void **aptr,
                 const void *bptr) {
    BOOLEAN_t *a = *aptr;
    const BOOLEAN_t *b = bptr;
