 ...
 */
asn_dec_rval_t NativeReal_decode_uper(const asn_codec_ctx_t *opt_codec_ctx,
    ...
    rval =
        OCTET_STRING_decode_uper(opt_codec_ctx, &asn_DEF_REAL, NULL, &ptmp, pd);
    if (rval.code != RC_OK) {
 ...
 */
asn_enc_rval_t NativeReal_encode_uper(const asn_TYPE_descriptor_t *td,
                                      const asn_per_constraints_t *constraints,
