...
>>>>>>> upstream/vlm_master
    ...
    ASN_DEBUG("PER Decoding %s size %" ASN_PRIdMAX " .. %" ASN_PRIdMAX
              " bits %d",
...
>>>>>>> upstream/vlm_master
    ...
    if (csiz->effective_bits >= 0 && !inext) {
        ASN_DEBUG("Encoding %" ASN_PRI_SIZE " bytes (%" ASN_PRIdMAX
                  "), length in %d bits",
    ...
    do {
        ...
        ASN_DEBUG("Encoding %" ASN_PRI_SSIZE " of %" ASN_PRI_SIZE "%s",
                  may_save, size_in_units, need_eom ? ",+EOM" : "");
