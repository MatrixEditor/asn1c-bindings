 ...
 */
asn_enc_rval_t REAL_encode_oer(const asn_TYPE_descriptor_t *td,
    ...
    if (!st || !st->buf || !td) ASN__ENCODE_FAILED;
...
asn_dec_rval_t REAL_decode_oer(const asn_codec_ctx_t *opt_codec_ctx,
