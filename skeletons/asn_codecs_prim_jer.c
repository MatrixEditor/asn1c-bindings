 ...
 */
static int jer_decode__unexpected_tag(void *key, const void *chunk_buf,
                                      size_t chunk_size) {
...
static ssize_t jer_decode__primitive_body(void *key, const void *chunk_buf,
...
asn_dec_rval_t jer_decode_primitive(
    ...
    void **sptr, size_t struct_size, const void *buf_ptr, size_t size,
    jer_primitive_body_decoder_f *prim_body_decoder) {
...
>>>>>>> upstream/vlm_master
                 ...
                 * Try to feed with empty body, see if it eats it.
                 */
                if (prim_body_decoder(s_arg.type_descriptor, s_arg.struct_key,
                                      &ch, 0) != JPBD_BODY_CONSUMED) {
                    /*
