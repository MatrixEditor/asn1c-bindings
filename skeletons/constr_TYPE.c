 ...
 */
int
get_asn1c_environment_version(void) {
 ...
 */
int
asn_copy(const asn_TYPE_descriptor_t *td, void **struct_dst,
...
int
asn_struct_init(const struct asn_TYPE_descriptor_s *type_descriptor,
                void *struct_ptr) {
