...
static asn_TYPE_member_t asn_MBR_S1AP_EXTERNAL__encoding_5[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct S1AP_encoding, choice.single_ASN1_type),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct S1AP_encoding, choice.octet_aligned),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct S1AP_encoding, choice.arbitrary),
...
static asn_CHOICE_specifics_t asn_SPC_S1AP_encoding_specs_5 = {
	sizeof(struct S1AP_encoding),
	offsetof(struct S1AP_encoding, _asn_ctx),
	offsetof(struct S1AP_encoding, present),
	sizeof(((struct S1AP_encoding *)0)->present),
...
asn_TYPE_descriptor_t asn_DEF_S1AP_encoding_5 = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_S1AP_encoding_constr_5,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
