...
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
static asn_per_constraints_t asn_PER_type_DL_CCCH_MessageType_constr_1 CC_NOTUSED = {
...
static asn_SEQUENCE_specifics_t asn_SPC_messageClassExtension_specs_4 = {
	sizeof(struct DL_CCCH_MessageType__c1__messageClassExtension),
	offsetof(struct DL_CCCH_MessageType__c1__messageClassExtension, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_c1_2[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct DL_CCCH_MessageType__c1, choice.messageClassExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
asn_TYPE_descriptor_t asn_DEF_DL_CCCH_MessageType = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_DL_CCCH_MessageType_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
